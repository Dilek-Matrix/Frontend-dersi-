        ...
        <div className="p-4">
            ...
            <div className={`demo-card demo-card-lg demo-toggle-card ${geceModu ? "demo-card-dark":""}`}>
                ...
                <div className="space-y-4">
                    <div>
                        <label className={geceModu? "demo-label-dark" : "demo-label"}>
                            Giriş Şifresi
                        </label>
                        <div className="relative">
                            <input type={sifreGoster? "text":"password"} value={girisSifre} onChange={(e)=>setGirisSifre(e.target.value)} className={geceModu ? "demo-input demo-input-dak pr-20" : "demo-input pr-20"} />
                        ...
                        <div className="demo-state-info">
                            ...
                            <ul className="demo-info-list">
                                ...
                                <li>Şifre Gösterimi<code>{sifreGoster ? "Açık":"Kapılı"}</code></li>
                            </ul>
