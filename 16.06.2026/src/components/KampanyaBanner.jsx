...
>>>>>>> 4d93793239644a1d92d2037a44f9a0f8f020d0b2
...
{/* 3. Saniyeyi Saat/Dakika/Saniye Formatına Çeviren Fonksiyon
...
{/*. return (Arayüz / JSX) Kısmı

  slider-bilgi: Kampanyanın başlığını ("Büyük Yaz İndirimleri Başladı!") ve açıklamasını içeren statik (sabit) reklam alanı.
  
  {formatCountdown(secondsLeft)}: İşte her saniye değişen sihirli yer burası! secondsLeft state'i her saniye azaldıkça, bu fonksiyon yeniden tetiklenir ve ekrandaki süre (örneğin 03:20:00 $\rightarrow$ 03:19:59 $\rightarrow$ 03:19:58) canlı olarak akar.
*/}
